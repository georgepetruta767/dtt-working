...
public class DictionaryPage extends PageObject {
    ...
    public void filter_by_destination(String destination, WebDriver webDriver) throws InterruptedException {
        ...
        getDefinitions(destination, webDriver);
    }

    public void getDefinitions(String destination, WebDriver webDriver) {
        String id = "location~" + destination;
        String url = "https://www.eximtur.ro/inscrieri-timpurii";
